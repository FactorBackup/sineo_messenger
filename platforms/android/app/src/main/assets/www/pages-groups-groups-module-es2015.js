...
let GroupsPage = class GroupsPage {
    constructor(router, loading, dataServices, modelCtrl) {
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.dataServices.keyGroups(firebase__WEBPACK_IMPORTED_MODULE_6__["auth"]().currentUser.uid).valueChanges().subscribe((groupIds) => {
