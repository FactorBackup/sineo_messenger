...
function extractCountryCallingCode(number, country, metadata) {
  number = (0, _parseIncompletePhoneNumber["default"])(number);
  ...
  if (number[0] !== '+') {
    ...
    var numberWithoutIDD = (0, _IDD.stripIDDPrefix)(number, country, metadata); // If an IDD prefix was stripped then
