	...
	module.exports = {
		payment : function (user_code, param, callback) {
			if( cordova.InAppBrowser ) {
				...
				if (device.platform == 'iOS') {
					payment_url = cordova.file.applicationDirectory + 'www/iamport-checkout-ios.html?user-code=' + user_code; //file protocol 로 열기
				} else if (device.platform == 'Android') {
					payment_url = '/_iamport_file_/www/' + payment_url; //inAppBrowser(fork)에서 인식할 수 있도록 _iamport_file_ 삽입
				}
		...
		certification : function (user_code, param, callback) {
			if( cordova.InAppBrowser ) {
				...
				if (device.platform == 'iOS') {
					certification_url = cordova.file.applicationDirectory + 'www/iamport-checkout-ios.html?user-code=' + user_code; //file protocol 로 열기
				} else if (device.platform == 'Android') {
					certification_url = '/_iamport_file_/www/' + certification_url; //inAppBrowser(fork)에서 인식할 수 있도록 _iamport_file_ 삽입
				}
