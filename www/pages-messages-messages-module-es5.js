...
var MessageComponent = /** @class */ (function (_super) {
    ...
    function MessageComponent(injector, http, navParams, authService, commonService, firestoreService, messageService, settingService) {
        ...
        _this.chat = [];
        _this.chatType = _models_message__WEBPACK_IMPORTED_MODULE_10__["CHAT_TYPES"];
        _this.textMsg = '';
        _this.images = [];
        _this.translated = '';
        _this.noDataconfig = {
    ...
    */
    ...
    MessageComponent.prototype.preview = function (image) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.openModal(src_shared_modals_image_preview_image_preview_component__WEBPACK_IMPORTED_MODULE_7__["ImagePreviewComponent"], image)];
                    case 1:
                        modal = _a.sent();
                        modal.present();
                        return [2 /*return*/];
