...
let NewGroupsPageModule = class NewGroupsPageModule {
};
...
let NewGroupsPage = class NewGroupsPage {
    constructor(dataServices, formBuilder, camera, router, toast, navCtrl, imageService, angularDb, loading, actionSheetController) {
    ...
    ngOnInit() {
        ...
        this.dataServices.getCurrentUser(firebase__WEBPACK_IMPORTED_MODULE_9__["auth"]().currentUser.uid).valueChanges().subscribe((account) => {
    ...
    showToast(message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const toastPresent = yield this.toast.create({
                message: message,
                duration: 300,
...
//# sourceMappingURL=pages-new-groups-new-groups-module-es2015.js.map