 ...
 */
let FeedService = class FeedService extends src_shared_helpers_extender__WEBPACK_IMPORTED_MODULE_6__["Extender"] {
    ...
    getFeed(uid) {
        return this.firestoreService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((_feed) => {
            const reads = [];
            ...
            return (this.feed = this.feed.map((item, index) => {
                return Object.assign({}, item, { userLiked: item.likes && Object(util__WEBPACK_IMPORTED_MODULE_8__["isArray"])(item.likes) ? item.likes.includes(uid) : false, user: data[index] || null });
            }));
        }));
    }
    getUserFeed(uid) {
    ...
    getPost(pid, uid) {
        let feed;
        return this.firestoreService.doc$(`feed/${pid}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((_feed) => {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((arr) => {
            const joins = ['user', 'comments'].reduce((acc, cur, idx) => {
                return Object.assign({}, acc, { [cur]: arr[idx] });
            }, {});
            return Object.assign({}, feed, joins, { userLiked: feed.likes && Object(util__WEBPACK_IMPORTED_MODULE_8__["isArray"])(feed.likes) ? feed.likes.includes(uid) : false });
        }));
    }
    searchFeed(val) {
    ...
    getComments(fid, uid) {
        return this.firestoreService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((_comment) => {
            const reads = [];
